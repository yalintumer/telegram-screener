...
class TestTelegramConfig:
    ...
    def test_valid_config(self):
        ...
        config = TelegramConfig(bot_token="1234567890:ABCdefGHIjklMNOpqrsTUVwxyz", chat_id="-100123456789")
...
class TestNotionConfig:
    ...
    def test_valid_config(self):
        ...
        config = NotionConfig(
            api_token="ntn_secret_abc123", signals_database_id="abc123def456", buy_database_id="xyz789ghi012"
        )
    ...
    def test_placeholder_api_token_rejected(self):
        ...
        with pytest.raises(ValueError, match="placeholder"):
            NotionConfig(api_token="YOUR_NOTION_TOKEN", signals_database_id="valid_db", buy_database_id="valid_db")

    def test_placeholder_signals_db_rejected(self):
        """Test that placeholder signals DB is rejected"""
        with pytest.raises(ValueError, match="placeholder"):
            NotionConfig(api_token="valid_token", signals_database_id="YOUR_SIGNALS_DB", buy_database_id="valid_db")
