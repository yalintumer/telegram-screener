...
class TestNotionClientInterfaceContract:
    ...
    def test_has_base_url_property(self):
        ...
        assert 'base_url' in init_source, \
            "NotionClient.__init__ should set 'base_url' attribute"
    ...
    def test_has_all_public_methods(self):
        ...
        for method_name in required_methods:
            ...
            assert callable(getattr(NotionClient, method_name)), \
                f"NotionClient.{method_name} is not callable"
...
class TestSignalTrackerInterfaceContract:
    ...
    def test_has_all_public_methods(self):
        ...
        for method_name in required_methods:
            ...
            assert callable(getattr(SignalTracker, method_name)), \
                f"SignalTracker.{method_name} is not callable"
...
class TestAnalyticsModuleInterfaceContract:
    ...
    def test_analytics_has_required_methods(self):
        ...
        for method_name in required_methods:
            ...
            assert callable(getattr(Analytics, method_name)), \
                f"Analytics.{method_name} is not callable"
