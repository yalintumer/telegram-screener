...
class TestMiniE2ESignalFlow:
    ...
    def test_full_signal_flow_fetch_filter_write_notify(
        ...
        from src.indicators import rsi as calc_rsi, stochastic_rsi, mfi as calc_mfi
        ...
        print(f"   ✅ Signal written to Notion (page_id: new_signal_page_123)")
...
"""
        ...
        print(f"   ✅ Telegram notification sent (message_id: 12345)")
